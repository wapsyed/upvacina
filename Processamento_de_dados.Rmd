...
vacinas_estado_sp %>% 
  ggsave(file = here("Figuras", "vacinas_estado_sp_2010_2022.png"), width = 12, height = 7)
...
IEPS_Completo_Regiao_SP_vacinas %>% 
  ggplot() +
  ...
  theme(text = element_text(size = 12),
        ...
        strip.text.x = element_text(size = 12,
                                    margin = margin(5, 5, 15, 5, "pt"))) +
  labs(title = "Cobertura vacinal de BCG",
       subtitle = "Período de 2010 a 2022",
       caption = "Fonte: IEPS, PNI, TabNet/DATASUS",
       y = "Cobertura vacinal (%)",
       x = "") 
