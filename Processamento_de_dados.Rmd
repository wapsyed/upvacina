...
estados_bcg = IEPS_Completo_2010_2022_selecionados %>% 
  ...
  estados_bcg %>% ggsave(file = here("Figuras", "Vacinas_Estados_2010_2022_BCG.png"), width = 15, height = 10)
...
IEPS_Completo_Municipio_SP_vacinas_ridge %>% 
    ggsave(file = here("Figuras", "Vacinas_Municipios_SP_2010_2022_densidade.png"), width = 15, height = 15)
